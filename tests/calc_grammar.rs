...
#[test]
fn test_hex() {
    assert_eq!(radix_calc::expr("0x0"), Ok(0x0));
...
#[test]
fn test_infix() {
    assert_eq!(radix_calc::expr("0 + 0"), Ok(0 + 0));
    assert_eq!(radix_calc::expr("0+ 0"), Ok(0 + 0));
    assert_eq!(radix_calc::expr("0 +0"), Ok(0 + 0));
    assert_eq!(radix_calc::expr("0+0"), Ok(0 + 0));
    ...
    assert_eq!(radix_calc::expr("5 - 4"), Ok(5 - 4));
    assert_eq!(radix_calc::expr("20 / 4"), Ok(20 / 4));
    assert_eq!(radix_calc::expr("20 % 4"), Ok(20 % 4));
    assert_eq!(radix_calc::expr("20 % 3"), Ok(20 % 3));
    assert_eq!(radix_calc::expr("2**5"), Ok(32));
    assert_eq!(radix_calc::expr("2 ** 5"), Ok(32));

    // negative test cases
    assert!(radix_calc::expr("5 $ 6").is_err());
}

#[test]
fn test_unary() {
    assert_eq!(radix_calc::expr("~5"), Ok(!5));
    assert_eq!(radix_calc::expr("-5"), Ok(-5));
}

#[test]
fn test_precedence() {
    assert_eq!(radix_calc::expr("2 + 5 * 4"), Ok(2 + 5 * 4));
    assert_eq!(radix_calc::expr("2 + 5 * ~4"), Ok(2 + 5 * !4));
    assert_eq!(radix_calc::expr("-2+5*4"), Ok(-2 + 5 * 4));
    assert_eq!(radix_calc::expr("-2 + 5 * 4"), Ok(-2 + 5 * 4));
    assert_eq!(radix_calc::expr("~2 + 5 * 4"), Ok(!2 + 5 * 4));
